	...
	const preguntas = [
		...
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Guepardo", puntuacionUno: 80},
				{respuestaDos: "Antílope", puntuacionDos: 10},
				{respuestaTres: "Caballo", puntuacionTres: 5},
				{respuestaCuatro: "León", puntuacionCuatro: 3},
				{respuestaCinco: "Coyote", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Asia", puntuacionUno: 60},
				{respuestaDos: "África", puntuacionDos: 20},
				{respuestaTres: "Europa", puntuacionTres: 10},
				{respuestaCuatro: "América", puntuacionCuatro: 7},
				{respuestaCinco: "Oceanía", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Facebook", puntuacionUno: 40},
				{respuestaDos: "YouTube", puntuacionDos: 30},
				{respuestaTres: "WhatsApp", puntuacionTres: 20},
				{respuestaCuatro: "Instagram", puntuacionCuatro: 8},
				{respuestaCinco: "TikTok", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Fútbol", puntuacionUno: 70},
				{respuestaDos: "Críquet", puntuacionDos: 15},
				{respuestaTres: "Baloncesto", puntuacionTres: 10},
				{respuestaCuatro: "Tenis", puntuacionCuatro: 3},
				{respuestaCinco: "Béisbol", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Hidráulica", puntuacionUno: 40},
				{respuestaDos: "Eólica", puntuacionDos: 30},
				{respuestaTres: "Solar", puntuacionTres: 20},
				{respuestaCuatro: "Geotérmica", puntuacionCuatro: 7},
				{respuestaCinco: "Biomasa", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Rusia", puntuacionUno: 50},
				{respuestaDos: "Canadá", puntuacionDos: 25},
				{respuestaTres: "China", puntuacionTres: 15},
				{respuestaCuatro: "Estados Unidos", puntuacionCuatro: 7},
				{respuestaCinco: "Brasil", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Océano Pacífico", puntuacionUno: 60},
				{respuestaDos: "Océano Atlántico", puntuacionDos: 20},
				{respuestaTres: "Océano Índico", puntuacionTres: 10},
				{respuestaCuatro: "Océano Ártico", puntuacionCuatro: 7},
				{respuestaCinco: "Océano Antártico", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Acero", puntuacionUno: 40},
				{respuestaDos: "Aluminio", puntuacionDos: 30},
				{respuestaTres: "Cobre", puntuacionTres: 20},
				{respuestaCuatro: "Hierro", puntuacionCuatro: 7},
				{respuestaCinco: "Plata", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "París", puntuacionUno: 40},
				{respuestaDos: "Londres", puntuacionDos: 30},
				{respuestaTres: "Nueva York", puntuacionTres: 20},
				{respuestaCuatro: "Dubái", puntuacionCuatro: 7},
				{respuestaCinco: "Tokio", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Teléfonos móviles", puntuacionUno: 50},
				{respuestaDos: "Internet", puntuacionDos: 30},
				{respuestaTres: "Correos electrónicos", puntuacionTres: 10},
				{respuestaCuatro: "Redes sociales", puntuacionCuatro: 7},
				{respuestaCinco: "Radio", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Pop", puntuacionUno: 40},
				{respuestaDos: "Rock", puntuacionDos: 30},
				{respuestaTres: "Hip-Hop", puntuacionTres: 20},
				{respuestaCuatro: "Música electrónica", puntuacionCuatro: 7},
				{respuestaCinco: "Jazz", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Petróleo", puntuacionUno: 50},
				{respuestaDos: "Electrónica", puntuacionDos: 30},
				{respuestaTres: "Vehículos", puntuacionTres: 10},
				{respuestaCuatro: "Productos farmacéuticos", puntuacionCuatro: 7},
				{respuestaCinco: "Maquinaria", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Oxígeno", puntuacionUno: 60},
				{respuestaDos: "Silicio", puntuacionDos: 20},
				{respuestaTres: "Aluminio", puntuacionTres: 10},
				{respuestaCuatro: "Hierro", puntuacionCuatro: 7},
				{respuestaCinco: "Calcio", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Guitarra", puntuacionUno: 50},
				{respuestaDos: "Piano", puntuacionDos: 30},
				{respuestaTres: "Violín", puntuacionTres: 10},
				{respuestaCuatro: "Batería", puntuacionCuatro: 7},
				{respuestaCinco: "Saxofón", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Arroz", puntuacionUno: 50},
				{respuestaDos: "Trigo", puntuacionDos: 30},
				{respuestaTres: "Maíz", puntuacionTres: 10},
				{respuestaCuatro: "Papas", puntuacionCuatro: 7},
				{respuestaCinco: "Yuca", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "China", puntuacionUno: 40},
				{respuestaDos: "India", puntuacionDos: 30},
				{respuestaTres: "Reino Unido", puntuacionTres: 15},
				{respuestaCuatro: "Turquía", puntuacionCuatro: 10},
				{respuestaCinco: "Japón", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "China", puntuacionUno: 50},
				{respuestaDos: "Japón", puntuacionDos: 25},
				{respuestaTres: "Alemania", puntuacionTres: 15},
				{respuestaCuatro: "Estados Unidos", puntuacionCuatro: 7},
				{respuestaCinco: "India", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Ballena azul", puntuacionUno: 60},
				{respuestaDos: "Tiburón ballena", puntuacionDos: 25},
				{respuestaTres: "Orca", puntuacionTres: 10},
				{respuestaCuatro: "Delfín nariz de botella", puntuacionCuatro: 4},
				{respuestaCinco: "Atún gigante", puntuacionCinco: 1}
			]
		},
		{
			titulo: "¿Cuál es el idioma más hablado en el mundo?",
			...
			respuestas: [
				{respuestaUno: "Inglés", puntuacionUno: 40},
				{respuestaDos: "Mandarín", puntuacionDos: 35},
				{respuestaTres: "Español", puntuacionTres: 15},
				{respuestaCuatro: "Hindú", puntuacionCuatro: 8},
				{respuestaCinco: "Árabe", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Fútbol", puntuacionUno: 55},
				{respuestaDos: "Críquet", puntuacionDos: 20},
				{respuestaTres: "Baloncesto", puntuacionTres: 12},
				{respuestaCuatro: "Tenis", puntuacionCuatro: 8},
				{respuestaCinco: "Béisbol", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Energía solar", puntuacionUno: 40},
				{respuestaDos: "Energía eólica", puntuacionDos: 35},
				{respuestaTres: "Energía hidroeléctrica", puntuacionTres: 15},
				{respuestaCuatro: "Energía geotérmica", puntuacionCuatro: 7},
				{respuestaCinco: "Energía de biomasa", puntuacionCinco: 3}
			]
		},
		{
		...
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Metro", puntuacionUno: 40},
				{respuestaDos: "Autobús", puntuacionDos: 35},
				{respuestaTres: "Tren", puntuacionTres: 15},
				{respuestaCuatro: "Tranvía", puntuacionCuatro: 7},
				{respuestaCinco: "Bicicleta compartida", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Teléfono móvil", puntuacionUno: 50},
				{respuestaDos: "Correo electrónico", puntuacionDos: 25},
				{respuestaTres: "Videollamadas", puntuacionTres: 15},
				{respuestaCuatro: "Redes sociales", puntuacionCuatro: 7},
				{respuestaCinco: "Mensajes de texto", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Agua", puntuacionUno: 60},
				{respuestaDos: "Petróleo", puntuacionDos: 25},
				{respuestaTres: "Gas natural", puntuacionTres: 10},
				{respuestaCuatro: "Carbón", puntuacionCuatro: 4},
				{respuestaCinco: "Minerales", puntuacionCinco: 1}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Netflix", puntuacionUno: 45},
				{respuestaDos: "YouTube", puntuacionDos: 30},
				{respuestaTres: "Amazon Prime Video", puntuacionTres: 15},
				{respuestaCuatro: "Disney+", puntuacionCuatro: 7},
				{respuestaCinco: "HBO Max", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Facebook", puntuacionUno: 55},
				{respuestaDos: "Instagram", puntuacionDos: 25},
				{respuestaTres: "TikTok", puntuacionTres: 15},
				{respuestaCuatro: "Twitter", puntuacionCuatro: 3},
				{respuestaCinco: "LinkedIn", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Información", puntuacionUno: 40},
				{respuestaDos: "Entretenimiento", puntuacionDos: 30},
				{respuestaTres: "Compras en línea", puntuacionTres: 20},
				{respuestaCuatro: "Educación", puntuacionCuatro: 7},
				{respuestaCinco: "Redes sociales", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Avión", puntuacionUno: 60},
				{respuestaDos: "Barco", puntuacionDos: 20},
				{respuestaTres: "Tren de alta velocidad", puntuacionTres: 15},
				{respuestaCuatro: "Coche", puntuacionCuatro: 3},
				{respuestaCinco: "Autobús", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Perro", puntuacionUno: 50},
				{respuestaDos: "Gato", puntuacionDos: 35},
				{respuestaTres: "Pez", puntuacionTres: 10},
				{respuestaCuatro: "Ave", puntuacionCuatro: 4},
				{respuestaCinco: "Hámster", puntuacionCinco: 1}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Chino mandarín", puntuacionUno: 45},
				{respuestaDos: "Español", puntuacionDos: 30},
				{respuestaTres: "Inglés", puntuacionTres: 15},
				{respuestaCuatro: "Hindi", puntuacionCuatro: 7},
				{respuestaCinco: "Árabe", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Internet", puntuacionUno: 50},
				{respuestaDos: "Teléfono móvil", puntuacionDos: 30},
				{respuestaTres: "Electricidad", puntuacionTres: 10},
				{respuestaCuatro: "Televisión", puntuacionCuatro: 7},
				{respuestaCinco: "Automóvil", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Navidad", puntuacionUno: 60},
				{respuestaDos: "Año Nuevo", puntuacionDos: 20},
				{respuestaTres: "Ramadán", puntuacionTres: 10},
				{respuestaCuatro: "Día de San Valentín", puntuacionCuatro: 7},
				{respuestaCinco: "Halloween", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Papel y cartón", puntuacionUno: 50},
				{respuestaDos: "Vidrio", puntuacionDos: 25},
				{respuestaTres: "Plástico", puntuacionTres: 15},
				{respuestaCuatro: "Aluminio", puntuacionCuatro: 7},
				{respuestaCinco: "Textiles", puntuacionCinco: 3}
			]
		},
		{
			titulo: "¿Cuál es el metal más utilizado en el mundo?",
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Hierro", puntuacionUno: 50},
				{respuestaDos: "Aluminio", puntuacionDos: 30},
				{respuestaTres: "Cobre", puntuacionTres: 10},
				{respuestaCuatro: "Oro", puntuacionCuatro: 7},
				{respuestaCinco: "Plata", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Júpiter", puntuacionUno: 75},
				{respuestaDos: "Saturno", puntuacionDos: 15},
				{respuestaTres: "Urano", puntuacionTres: 5},
				{respuestaCuatro: "Neptuno", puntuacionCuatro: 3},
				{respuestaCinco: "Tierra", puntuacionCinco: 2}
			]
		},
		{
			...
			respuestas: [
				{respuestaUno: "Arroz", puntuacionUno: 50},
				{respuestaDos: "Sushi", puntuacionDos: 20},
				{respuestaTres: "Pescado", puntuacionTres: 15},
				{respuestaCuatro: "Fideos", puntuacionCuatro: 10},
				{respuestaCinco: "Verduras", puntuacionCinco: 5}
			]
		},
		{
			titulo: "¿Cuál es la aplicación más comúnmente utilizada en dispositivos móviles?",
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Facebook", puntuacionUno: 60},
				{respuestaDos: "Instagram", puntuacionDos: 20},
				{respuestaTres: "Youtube", puntuacionTres: 10},
				{respuestaCuatro: "TikTok", puntuacionCuatro: 5},
				{respuestaCinco: "Mensajeria", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Té", puntuacionUno: 40},
				{respuestaDos: "Café", puntuacionDos: 35},
				{respuestaTres: "Refrescos", puntuacionTres: 15},
				{respuestaCuatro: "Jugo", puntuacionCuatro: 5},
				{respuestaCinco: "Agua mineral", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Seguridad", puntuacionUno: 50},
				{respuestaDos: "Bonita Vecindad", puntuacionDos: 30},
				{respuestaTres: "Acceso a servicios", puntuacionTres: 15},
				{respuestaCuatro: "Bonita Casa", puntuacionCuatro: 3},
				{respuestaCinco: "Vecinos", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Escenas de persecución", puntuacionUno: 50},
				{respuestaDos: "Explosiones", puntuacionDos: 30},
				{respuestaTres: "Luchas cuerpo a cuerpo", puntuacionTres: 10},
				{respuestaCuatro: "Peleas con armas", puntuacionCuatro: 7},
				{respuestaCinco: "Viajes en el tiempo", puntuacionCinco: 3}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Japón", puntuacionUno: 70},
				{respuestaDos: "Estados Unidos", puntuacionDos: 20},
				{respuestaTres: "Alemania", puntuacionTres: 5},
				{respuestaCuatro: "Corea del Sur", puntuacionCuatro: 3},
				{respuestaCinco: "China", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Fantasmales", puntuacionUno: 60},
				{respuestaDos: "Asesinos en serie", puntuacionDos: 20},
				{respuestaTres: "Zombis", puntuacionTres: 10},
				{respuestaCuatro: "Criaturas extrañas", puntuacionCuatro: 5},
				{respuestaCinco: "Cuentos de hadas", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Eficiencia de combustible", puntuacionUno: 45},
				{respuestaDos: "Precio", puntuacionDos: 30},
				{respuestaTres: "Seguridad", puntuacionTres: 15},
				{respuestaCuatro: "Diseño", puntuacionCuatro: 5},
				{respuestaCinco: "Marca", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Ver televisión", puntuacionUno: 40},
				{respuestaDos: "Jugar videojuegos", puntuacionDos: 30},
				{respuestaTres: "Escuchar música", puntuacionTres: 15},
				{respuestaCuatro: "Leer", puntuacionCuatro: 10},
				{respuestaCinco: "Hacer deporte", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Clima templado", puntuacionUno: 50},
				{respuestaDos: "Clima cálido", puntuacionDos: 25},
				{respuestaTres: "Clima frío", puntuacionTres: 15},
				{respuestaCuatro: "Clima húmedo", puntuacionCuatro: 5},
				{respuestaCinco: "Clima seco", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Automóvil propio", puntuacionUno: 50},
				{respuestaDos: "Transporte público", puntuacionDos: 25},
				{respuestaTres: "Bicicleta", puntuacionTres: 15},
				{respuestaCuatro: "Caminar", puntuacionCuatro: 5},
				{respuestaCinco: "Moto", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Comida rápida", puntuacionUno: 50},
				{respuestaDos: "Comida casera", puntuacionDos: 25},
				{respuestaTres: "Comida italiana", puntuacionTres: 10},
				{respuestaCuatro: "Comida asiática", puntuacionCuatro: 10},
				{respuestaCinco: "Comida mexicana", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Instagram", puntuacionUno: 40},
				{respuestaDos: "TikTok", puntuacionDos: 30},
				{respuestaTres: "Facebook", puntuacionTres: 15},
				{respuestaCuatro: "Snapchat", puntuacionCuatro: 10},
				{respuestaCinco: "Twitter", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Fútbol americano", puntuacionUno: 60},
				{respuestaDos: "Básquetbol", puntuacionDos: 25},
				{respuestaTres: "Beisbol", puntuacionTres: 10},
				{respuestaCuatro: "Fútbol", puntuacionCuatro: 3},
				{respuestaCinco: "Hockey sobre hielo", puntuacionCinco: 2}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Precio", puntuacionUno: 45},
				{respuestaDos: "Variedad de productos", puntuacionDos: 25},
				{respuestaTres: "Tiempo de entrega", puntuacionTres: 15},
				{respuestaCuatro: "Reputación de la tienda", puntuacionCuatro: 10},
				{respuestaCinco: "Promociones", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Ver películas o series", puntuacionUno: 40},
				{respuestaDos: "Leer", puntuacionDos: 30},
				{respuestaTres: "Salir con amigos", puntuacionTres: 15},
				{respuestaCuatro: "Hacer ejercicio", puntuacionCuatro: 10},
				{respuestaCinco: "Viajar", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Bailar", puntuacionUno: 40},
				{respuestaDos: "Comer", puntuacionDos: 30},
				{respuestaTres: "Socializar", puntuacionTres: 15},
				{respuestaCuatro: "Jugar juegos", puntuacionCuatro: 10},
				{respuestaCinco: "Escuchar música", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Confianza", puntuacionUno: 50},
				{respuestaDos: "Respeto", puntuacionDos: 30},
				{respuestaTres: "Amor", puntuacionTres: 10},
				{respuestaCuatro: "Compañerismo", puntuacionCuatro: 5},
				{respuestaCinco: "Sentido del humor", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Meditar", puntuacionUno: 40},
				{respuestaDos: "Escuchar música", puntuacionDos: 30},
				{respuestaTres: "Leer", puntuacionTres: 15},
				{respuestaCuatro: "Hacer ejercicio", puntuacionCuatro: 10},
				{respuestaCinco: "Salir al aire libre", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Rendimiento", puntuacionUno: 40},
				{respuestaDos: "Precio", puntuacionDos: 30},
				{respuestaTres: "Cámara", puntuacionTres: 15},
				{respuestaCuatro: "Duración de batería", puntuacionCuatro: 10},
				{respuestaCinco: "Diseño", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Género", puntuacionUno: 40},
				{respuestaDos: "Director", puntuacionDos: 30},
				{respuestaTres: "Elenco", puntuacionTres: 15},
				{respuestaCuatro: "Reseñas", puntuacionCuatro: 10},
				{respuestaCinco: "Duración", puntuacionCinco: 5}
			]
		},
		{
			...
			respuestas: [
				{respuestaUno: "Internet", puntuacionUno: 50},
				{respuestaDos: "Smartphones", puntuacionDos: 30},
				{respuestaTres: "Inteligencia artificial", puntuacionTres: 10},
				{respuestaCuatro: "Redes sociales", puntuacionCuatro: 5},
				{respuestaCinco: "Robótica", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Estilo", puntuacionUno: 40},
				{respuestaDos: "Comodidad", puntuacionDos: 30},
				{respuestaTres: "Precio", puntuacionTres: 15},
				{respuestaCuatro: "Marca", puntuacionCuatro: 10},
				{respuestaCinco: "Tendencia", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "TikTok", puntuacionUno: 50},
				{respuestaDos: "Instagram", puntuacionDos: 30},
				{respuestaTres: "Snapchat", puntuacionTres: 10},
				{respuestaCuatro: "Facebook", puntuacionCuatro: 5},
				{respuestaCinco: "Twitter", puntuacionCinco: 5}
			]
		},
		{
			...
			tipo: "normal",
			respuestas: [
				{respuestaUno: "Comunicación", puntuacionUno: 50},
				{respuestaDos: "Confianza", puntuacionDos: 30},
				{respuestaTres: "Respeto mutuo", puntuacionTres: 10},
				{respuestaCuatro: "Intereses comunes", puntuacionCuatro: 5},
				{respuestaCinco: "Atracción física", puntuacionCinco: 5}
			]
		},

		{
			titulo: "¿Qué bebida es la más consumida en el mundo?",
			tipo: "alimentos",
			respuestas: [
				{ respuestaUno: "Agua", puntuacionUno: 50 },
				{ respuestaDos: "Té", puntuacionDos: 25 },
				{ respuestaTres: "Café", puntuacionTres: 15 },
				{ respuestaCuatro: "Refrescos", puntuacionCuatro: 7 },
				{ respuestaCinco: "Cerveza", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Qué comida les gusta más a los mexicanos?",
			tipo: "alimentos",
			respuestas: [
				{ respuestaUno: "Tacos", puntuacionUno: 40 },
				{ respuestaDos: "Tamales", puntuacionDos: 30 },
				{ respuestaTres: "Pozole", puntuacionTres: 15 },
				{ respuestaCuatro: "Enchiladas", puntuacionCuatro: 10 },
				{ respuestaCinco: "Sopes", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es el color más preferido por las personas?",
			tipo: "preferencias",
			respuestas: [
				{ respuestaUno: "Azul", puntuacionUno: 35 },
				{ respuestaDos: "Rojo", puntuacionDos: 25 },
				{ respuestaTres: "Verde", puntuacionTres: 20 },
				{ respuestaCuatro: "Negro", puntuacionCuatro: 15 },
				{ respuestaCinco: "Blanco", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es la tecnología más utilizada para la comunicación instantánea?",
			tipo: "tecnología",
			respuestas: [
				{ respuestaUno: "WhatsApp", puntuacionUno: 45 },
				{ respuestaDos: "Facebook Messenger", puntuacionDos: 30 },
				{ respuestaTres: "WeChat", puntuacionTres: 15 },
				{ respuestaCuatro: "Telegram", puntuacionCuatro: 7 },
				{ respuestaCinco: "Line", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Cuál es la empresa tecnológica más grande del mundo?",
			tipo: "tecnología",
			respuestas: [
				{ respuestaUno: "Apple", puntuacionUno: 50 },
				{ respuestaDos: "Microsoft", puntuacionDos: 25 },
				{ respuestaTres: "Google", puntuacionTres: 15 },
				{ respuestaCuatro: "Amazon", puntuacionCuatro: 7 },
				{ respuestaCinco: "Samsung", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Qué país consume más pescado per cápita?",
			tipo: "alimentos",
			respuestas: [
				{ respuestaUno: "Japón", puntuacionUno: 40 },
				{ respuestaDos: "Noruega", puntuacionDos: 25 },
				{ respuestaTres: "Islandia", puntuacionTres: 20 },
				{ respuestaCuatro: "Portugal", puntuacionCuatro: 10 },
				{ respuestaCinco: "Corea del Sur", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Qué ciudad es considerada el centro financiero más importante del mundo?",
			tipo: "economía",
			respuestas: [
				{ respuestaUno: "Nueva York", puntuacionUno: 40 },
				{ respuestaDos: "Londres", puntuacionDos: 30 },
				{ respuestaTres: "Tokio", puntuacionTres: 15 },
				{ respuestaCuatro: "Hong Kong", puntuacionCuatro: 10 },
				{ respuestaCinco: "Singapur", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Qué animal es conocido por ser el más inteligente?",
			tipo: "animales",
			respuestas: [
				{ respuestaUno: "Delfín", puntuacionUno: 40 },
				{ respuestaDos: "Chimpancé", puntuacionDos: 30 },
				{ respuestaTres: "Elefante", puntuacionTres: 15 },
				{ respuestaCuatro: "Perro", puntuacionCuatro: 10 },
				{ respuestaCinco: "Cuervo", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es la moneda más utilizada en el mundo?",
			tipo: "economía",
			respuestas: [
				{ respuestaUno: "Dólar estadounidense", puntuacionUno: 50 },
				{ respuestaDos: "Euro", puntuacionDos: 25 },
				{ respuestaTres: "Yen japonés", puntuacionTres: 15 },
				{ respuestaCuatro: "Libra esterlina", puntuacionCuatro: 7 },
				{ respuestaCinco: "Franco suizo", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Cuál es el animal terrestre más grande?",
			tipo: "naturaleza",
			respuestas: [
				{ respuestaUno: "Elefante africano", puntuacionUno: 50 },
				{ respuestaDos: "Rinoceronte blanco", puntuacionDos: 20 },
				{ respuestaTres: "Jirafa", puntuacionTres: 15 },
				{ respuestaCuatro: "Hipopótamo", puntuacionCuatro: 10 },
				{ respuestaCinco: "Bisonte", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es la moneda más utilizada en el comercio internacional?",
			tipo: "economía",
			respuestas: [
				{ respuestaUno: "Dólar estadounidense", puntuacionUno: 50 },
				{ respuestaDos: "Euro", puntuacionDos: 30 },
				{ respuestaTres: "Yen japonés", puntuacionTres: 10 },
				{ respuestaCuatro: "Libra esterlina", puntuacionCuatro: 7 },
				{ respuestaCinco: "Yuan chino", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Cuál es el invento que más ha revolucionado la comunicación?",
			tipo: "historia",
			respuestas: [
				{ respuestaUno: "Internet", puntuacionUno: 50 },
				{ respuestaDos: "Teléfono", puntuacionDos: 30 },
				{ respuestaTres: "Imprenta", puntuacionTres: 10 },
				{ respuestaCuatro: "Radio", puntuacionCuatro: 8 },
				{ respuestaCinco: "Televisión", puntuacionCinco: 2 }
			]
		},
		{
			titulo: "¿Qué actividad física es más practicada globalmente?",
			tipo: "deporte",
			respuestas: [
				{ respuestaUno: "Caminar", puntuacionUno: 50 },
				{ respuestaDos: "Correr", puntuacionDos: 25 },
				{ respuestaTres: "Nadar", puntuacionTres: 15 },
				{ respuestaCuatro: "Ciclismo", puntuacionCuatro: 8 },
				{ respuestaCinco: "Yoga", puntuacionCinco: 2 }
			]
		},
		{
			titulo: "¿Cuál es el arte más valorado a nivel mundial?",
			tipo: "cultura",
			respuestas: [
				{ respuestaUno: "Pintura", puntuacionUno: 40 },
				{ respuestaDos: "Música", puntuacionDos: 35 },
				{ respuestaTres: "Cine", puntuacionTres: 15 },
				{ respuestaCuatro: "Literatura", puntuacionCuatro: 8 },
				{ respuestaCinco: "Danza", puntuacionCinco: 2 }
			]
		},
		{
			titulo: "¿Qué tipo de comida es más consumida durante el desayuno?",
			tipo: "comida",
			respuestas: [
				{ respuestaUno: "Cereal", puntuacionUno: 35 },
				{ respuestaDos: "Huevos", puntuacionDos: 30 },
				{ respuestaTres: "Pan tostado", puntuacionTres: 20 },
				{ respuestaCuatro: "Fruta", puntuacionCuatro: 10 },
				{ respuestaCinco: "Yogur", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es el país con más turistas anuales?",
			tipo: "turismo",
			respuestas: [
				{ respuestaUno: "Francia", puntuacionUno: 50 },
				{ respuestaDos: "Estados Unidos", puntuacionDos: 30 },
				{ respuestaTres: "España", puntuacionTres: 15 },
				{ respuestaCuatro: "Italia", puntuacionCuatro: 5 },
				{ respuestaCinco: "China", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Qué género de películas es el más popular?",
			tipo: "entretenimiento",
			respuestas: [
				{ respuestaUno: "Acción", puntuacionUno: 35 },
				{ respuestaDos: "Comedia", puntuacionDos: 30 },
				{ respuestaTres: "Drama", puntuacionTres: 20 },
				{ respuestaCuatro: "Terror", puntuacionCuatro: 10 },
				{ respuestaCinco: "Ciencia ficción", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es el instrumento musical más tocado en el mundo?",
			tipo: "música",
			respuestas: [
				{ respuestaUno: "Piano", puntuacionUno: 40 },
				{ respuestaDos: "Guitarra", puntuacionDos: 30 },
				{ respuestaTres: "Violín", puntuacionTres: 15 },
				{ respuestaCuatro: "Batería", puntuacionCuatro: 10 },
				{ respuestaCinco: "Flauta", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es la fruta más consumida en el mundo?",
			tipo: "alimentos",
			respuestas: [
				{ respuestaUno: "Banana", puntuacionUno: 40 },
				{ respuestaDos: "Manzana", puntuacionDos: 30 },
				{ respuestaTres: "Uva", puntuacionTres: 15 },
				{ respuestaCuatro: "Naranja", puntuacionCuatro: 10 },
				{ respuestaCinco: "Sandía", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Qué país es el mayor exportador de tecnología?",
			tipo: "economía",
			respuestas: [
				{ respuestaUno: "China", puntuacionUno: 50 },
				{ respuestaDos: "Estados Unidos", puntuacionDos: 30 },
				{ respuestaTres: "Alemania", puntuacionTres: 10 },
				{ respuestaCuatro: "Japón", puntuacionCuatro: 7 },
				{ respuestaCinco: "Corea del Sur", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Qué sistema operativo es más usado en el mundo?",
			tipo: "tecnología",
			respuestas: [
				{ respuestaUno: "Windows", puntuacionUno: 50 },
				{ respuestaDos: "Android", puntuacionDos: 30 },
				{ respuestaTres: "iOS", puntuacionTres: 10 },
				{ respuestaCuatro: "MacOS", puntuacionCuatro: 7 },
				{ respuestaCinco: "Linux", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Cuál es el material más utilizado en la construcción?",
			tipo: "infraestructura",
			respuestas: [
				{ respuestaUno: "Concreto", puntuacionUno: 45 },
				{ respuestaDos: "Acero", puntuacionDos: 30 },
				{ respuestaTres: "Madera", puntuacionTres: 15 },
				{ respuestaCuatro: "Ladrillo", puntuacionCuatro: 8 },
				{ respuestaCinco: "Vidrio", puntuacionCinco: 2 }
			]
		},
		{
			titulo: "¿Qué es lo más común que la gente hace en vacaciones?",
			tipo: "estilo de vida",
			respuestas: [
				{ respuestaUno: "Viajar", puntuacionUno: 50 },
				{ respuestaDos: "Quedarse en casa", puntuacionDos: 20 },
				{ respuestaTres: "Ir a la playa", puntuacionTres: 15 },
				{ respuestaCuatro: "Hacer actividades recreativas", puntuacionCuatro: 10 },
				{ respuestaCinco: "Visitar a familiares", puntuacionCinco: 5 }
			]
		},
		{
			titulo: "¿Cuál es la festividad más celebrada globalmente?",
			tipo: "cultura",
			respuestas: [
				{ respuestaUno: "Navidad", puntuacionUno: 60 },
				{ respuestaDos: "Año Nuevo", puntuacionDos: 25 },
				{ respuestaTres: "Ramadán", puntuacionTres: 8 },
				{ respuestaCuatro: "Halloween", puntuacionCuatro: 5 },
				{ respuestaCinco: "Día de San Valentín", puntuacionCinco: 2 }
			]
		},
		{
			titulo: "¿Qué vehículo es más común en las ciudades?",
			tipo: "transporte",
			respuestas: [
				{ respuestaUno: "Automóvil", puntuacionUno: 50 },
				{ respuestaDos: "Motocicleta", puntuacionDos: 30 },
				{ respuestaTres: "Bicicleta", puntuacionTres: 10 },
				{ respuestaCuatro: "Autobús", puntuacionCuatro: 8 },
				{ respuestaCinco: "Scooter eléctrico", puntuacionCinco: 2 }
			]
		},
		{
			titulo: "¿Cuál es la comida rápida más popular en el mundo?",
			tipo: "alimentación",
			respuestas: [
				{ respuestaUno: "Hamburguesas", puntuacionUno: 45 },
				{ respuestaDos: "Pizza", puntuacionDos: 30 },
				{ respuestaTres: "Papas fritas", puntuacionTres: 15 },
				{ respuestaCuatro: "Tacos", puntuacionCuatro: 7 },
				{ respuestaCinco: "Hot dogs", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Cuál es el electrodoméstico más usado en el hogar?",
			tipo: "hogar",
			respuestas: [
				{ respuestaUno: "Refrigerador", puntuacionUno: 50 },
				{ respuestaDos: "Microondas", puntuacionDos: 25 },
				{ respuestaTres: "Lavadora", puntuacionTres: 15 },
				{ respuestaCuatro: "Televisión", puntuacionCuatro: 7 },
				{ respuestaCinco: "Aspiradora", puntuacionCinco: 3 }
			]
		},
		{
			titulo: "¿Qué animal es más conocido como mascota?",
			tipo: "naturaleza",
			respuestas: [
				{ respuestaUno: "Perro", puntuacionUno: 50 },
				{ respuestaDos: "Gato", puntuacionDos: 30 },
				{ respuestaTres: "Pez", puntuacionTres: 10 },
				{ respuestaCuatro: "Ave", puntuacionCuatro: 7 },
				{ respuestaCinco: "Hámster", puntuacionCinco: 3 }
			]
		},
		{
			  titulo: "¿Cuál es la tarea doméstica más odiada?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Lavar los trastes", "puntuacionUno": 40 },
				  { respuestaDos: "Planchar", "puntuacionDos": 30 },
				  { respuestaTres: "Limpiar el baño", "puntuacionTres": 20 },
				  { respuestaCuatro: "Barrer", "puntuacionCuatro": 5 },
				  { respuestaCinco: "Lavar ropa", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué objeto nunca puede faltar en una cocina?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Cuchillo", "puntuacionUno": 35 },
				  { respuestaDos: "Sartenes", "puntuacionDos": 25 },
				  { respuestaTres: "Olla", "puntuacionTres": 20 },
				  { respuestaCuatro: "Tabla de picar", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Cuchara", "puntuacionCinco": 10 }
			  ]
		  },
		  {
			  titulo: "¿Qué se revisa antes de salir de casa?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Que las luces estén apagadas", "puntuacionUno": 40 },
				  { respuestaDos: "Cerrar la puerta con llave", "puntuacionDos": 30 },
				  { respuestaTres: "Cerrar las ventanas", "puntuacionTres": 15 },
				  { respuestaCuatro: "Que el gas esté cerrado", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Tomar el celular", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué es lo primero que se limpia en la casa?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "La sala", "puntuacionUno": 35 },
				  { respuestaDos: "La cocina", "puntuacionDos": 30 },
				  { respuestaTres: "El baño", "puntuacionTres": 20 },
				  { respuestaCuatro: "Los cuartos", "puntuacionCuatro": 10 },
				  { respuestaCinco: "El patio", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué aparato de la casa usa más electricidad?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Refrigerador", "puntuacionUno": 45 },
				  { respuestaDos: "Aire acondicionado", "puntuacionDos": 30 },
				  { respuestaTres: "Televisión", "puntuacionTres": 15 },
				  { respuestaCuatro: "Computadora", "puntuacionCuatro": 5 },
				  { respuestaCinco: "Microondas", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué objeto se usa para limpiar la casa?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Escoba", "puntuacionUno": 50 },
				  { respuestaDos: "Trapeador", "puntuacionDos": 25 },
				  { respuestaTres: "Aspiradora", "puntuacionTres": 15 },
				  { respuestaCuatro: "Plumero", "puntuacionCuatro": 7 },
				  { respuestaCinco: "Esponja", "puntuacionCinco": 3 }
			  ]
		  },
		  {
			  titulo: "¿Qué cuarto de la casa es el más desordenado?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Habitación de los niños", "puntuacionUno": 40 },
				  { respuestaDos: "Sala", "puntuacionDos": 30 },
				  { respuestaTres: "Cocina", "puntuacionTres": 20 },
				  { respuestaCuatro: "Baño", "puntuacionCuatro": 5 },
				  { respuestaCinco: "Garaje", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué alimento se encuentra en todas las cocinas?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Arroz", "puntuacionUno": 35 },
				  { respuestaDos: "Frijoles", "puntuacionDos": 25 },
				  { respuestaTres: "Aceite", "puntuacionTres": 20 },
				  { respuestaCuatro: "Sal", "puntuacionCuatro": 15 },
				  { respuestaCinco: "Azúcar", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué es lo primero que haces al levantarte?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Ir al baño", "puntuacionUno": 40 },
				  { respuestaDos: "Tomar agua o café", "puntuacionDos": 25 },
				  { respuestaTres: "Tender la cama", "puntuacionTres": 20 },
				  { respuestaCuatro: "Revisar el celular", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Abrir las cortinas", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué cosas hay en una mesa del comedor?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Platos", "puntuacionUno": 35 },
				  { respuestaDos: "Vasos", "puntuacionDos": 25 },
				  { respuestaTres: "Cucharas", "puntuacionTres": 20 },
				  { respuestaCuatro: "Servilletas", "puntuacionCuatro": 15 },
				  { respuestaCinco: "Salero", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué se encuentra en el baño de cualquier casa?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Papel higiénico", "puntuacionUno": 50 },
				  { respuestaDos: "Jabón", "puntuacionDos": 30 },
				  { respuestaTres: "Espejo", "puntuacionTres": 10 },
				  { respuestaCuatro: "Cepillo de dientes", "puntuacionCuatro": 7 },
				  { respuestaCinco: "Toalla", "puntuacionCinco": 3 }
			  ]
		  },
		  {
			  titulo: "¿Qué se usa para mantener la casa fresca?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Ventilador", "puntuacionUno": 40 },
				  { respuestaDos: "Aire acondicionado", "puntuacionDos": 35 },
				  { respuestaTres: "Abrir ventanas", "puntuacionTres": 15 },
				  { respuestaCuatro: "Cortinas cerradas", "puntuacionCuatro": 7 },
				  { respuestaCinco: "Agua fría", "puntuacionCinco": 3 }
			  ]
		  },
		  {
			  titulo: "¿Qué se guarda en el refrigerador?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Leche", "puntuacionUno": 40 },
				  { respuestaDos: "Carne", "puntuacionDos": 30 },
				  { respuestaTres: "Huevos", "puntuacionTres": 15 },
				  { respuestaCuatro: "Frutas", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Verduras", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué sueles encontrar en una sala?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Sofá", "puntuacionUno": 50 },
				  { respuestaDos: "Televisión", "puntuacionDos": 30 },
				  { respuestaTres: "Mesa de centro", "puntuacionTres": 10 },
				  { respuestaCuatro: "Alfombra", "puntuacionCuatro": 7 },
				  { respuestaCinco: "Lámpara", "puntuacionCinco": 3 }
			  ]
		  },
		  {
			  titulo: "¿Qué se usa para decorar la casa?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Cuadros", "puntuacionUno": 40 },
				  { respuestaDos: "Plantas", "puntuacionDos": 30 },
				  { respuestaTres: "Cortinas", "puntuacionTres": 15 },
				  { respuestaCuatro: "Velas", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Figuras decorativas", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué haces cuando llega visita inesperada?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Ofrecer algo de tomar", "puntuacionUno": 40 },
				  { respuestaDos: "Limpiar rápidamente", "puntuacionDos": 30 },
				  { respuestaTres: "Preparar comida", "puntuacionTres": 15 },
				  { respuestaCuatro: "Apagar las luces y no abrir", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Arreglarse", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué cosa se pierde más en una casa?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Controles remotos", "puntuacionUno": 35 },
				  { respuestaDos: "Llaves", "puntuacionDos": 30 },
				  { respuestaTres: "Teléfonos", "puntuacionTres": 20 },
				  { respuestaCuatro: "Lentes", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Calcetines", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué haces antes de acostarte?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Cepillarme los dientes", "puntuacionUno": 40 },
				  { respuestaDos: "Cerrar puertas y ventanas", "puntuacionDos": 30 },
				  { respuestaTres: "Apagar luces", "puntuacionTres": 15 },
				  { respuestaCuatro: "Revisar el celular", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Leer", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué es lo más difícil de mantener limpio?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "El baño", "puntuacionUno": 45 },
				  { respuestaDos: "La cocina", "puntuacionDos": 30 },
				  { respuestaTres: "El piso", "puntuacionTres": 15 },
				  { respuestaCuatro: "Los cristales", "puntuacionCuatro": 5 },
				  { respuestaCinco: "El comedor", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué compras más seguido para el hogar?",
			  tipo: "hogar",
			  respuestas: [
				  { respuestaUno: "Comida", "puntuacionUno": 50 },
				  { respuestaDos: "Productos de limpieza", "puntuacionDos": 25 },
				  { respuestaTres: "Papel higiénico", "puntuacionTres": 15 },
				  { respuestaCuatro: "Bebidas", "puntuacionCuatro": 7 },
				  { respuestaCinco: "Velas aromáticas", "puntuacionCinco": 3 }
			  ]
		  },
		  {
			  titulo: "¿Qué alimento compras siempre en el súper?",
			  tipo: "alimentos",
			  respuestas: [
				  { respuestaUno: "Leche", "puntuacionUno": 40 },
				  { respuestaDos: "Pan", "puntuacionDos": 30 },
				  { respuestaTres: "Huevos", "puntuacionTres": 15 },
				  { respuestaCuatro: "Frutas", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Verduras", "puntuacionCinco": 5 }
			  ]
		  ...
		  {
			  titulo: "¿Qué es lo que más causa peleas en una pareja?",
			  tipo: "relaciones",
			  respuestas: [
				  { respuestaUno: "Dinero", "puntuacionUno": 35 },
				  { respuestaDos: "Celos", "puntuacionDos": 30 },
				  { respuestaTres: "Falta de comunicación", "puntuacionTres": 20 },
				  { respuestaCuatro: "Tareas del hogar", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Amistades", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué es lo primero que atrae de una persona?",
			  tipo: "relaciones",
			  respuestas: [
				  { respuestaUno: "Apariencia física", "puntuacionUno": 50 },
				  { respuestaDos: "Personalidad", "puntuacionDos": 30 },
				  { respuestaTres: "Sentido del humor", "puntuacionTres": 10 },
				  { respuestaCuatro: "Manera de hablar", "puntuacionCuatro": 7 },
				  { respuestaCinco: "Estilo", "puntuacionCinco": 3 }
			  ]
		  },
		  {
			  titulo: "¿Qué suelen hacer las parejas en una cita romántica?",
			  tipo: "relaciones",
			  respuestas: [
				  { respuestaUno: "Ir a cenar", "puntuacionUno": 40 },
				  { respuestaDos: "Ver una película", "puntuacionDos": 30 },
				  { respuestaTres: "Ir al parque", "puntuacionTres": 15 },
				  { respuestaCuatro: "Tomar café", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Ir de paseo", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué regalo es común en un aniversario de pareja?",
			  tipo: "relaciones",
			  respuestas: [
				  { respuestaUno: "Flores", "puntuacionUno": 40 },
				  { respuestaDos: "Cena romántica", "puntuacionDos": 30 },
				  { respuestaTres: "Joyas", "puntuacionTres": 15 },
				  { respuestaCuatro: "Peluches", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Cartas de amor", "puntuacionCinco": 5 }
			  ]
		  },
		  {
			  titulo: "¿Qué parte del cuerpo humano es responsable de la coordinación y el equilibrio?",
			  tipo: "cuerpo",
			  respuestas: [
				  { respuestaUno: "Cerebro", "puntuacionUno": 40 },
				  { respuestaDos: "Oídos", "puntuacionDos": 30 },
				  { respuestaTres: "Ojos", "puntuacionTres": 15 },
				  { respuestaCuatro: "Pies", "puntuacionCuatro": 10 },
				  { respuestaCinco: "Columna vertebral", "puntuacionCinco": 5 }
			  ]
		  }
	]
